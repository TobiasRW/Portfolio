export default function Footer() {
  return (
    <footer className="bg-whitebg mt-20 flex h-32 items-end rounded-t-[40px] lg:h-40 lg:rounded-t-[50px] 2xl:h-48 2xl:rounded-t-[70px] dark:bg-[#1a1a1a] dark:text-white">
      <div className="font-heading mx-auto flex w-11/12 max-w-[1920px] items-center justify-between py-4 text-lg font-semibold md:text-2xl lg:py-8 lg:text-3xl 2xl:text-4xl">
