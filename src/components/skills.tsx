...
export const Skills = () => {
  ...
  return (
    <div className="w-full rounded-b-[40px] bg-whitebg pb-20 pt-10 md:pb-24 md:pt-14 lg:pb-28 xl:pb-32 xl:pt-20 dark:bg-[#1a1a1a]">
      <div className="container mx-auto">
        <div className="flex flex-col gap-10 md:gap-14 xl:gap-16 2xl:gap-20">
          ...
          <div className="relative">
            {/* Fading effect */}
            <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-20 bg-gradient-to-r from-whitebg to-transparent md:w-24 lg:w-28 2xl:w-32 dark:from-[#1a1a1a]"></div>
            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-20 bg-gradient-to-l from-whitebg to-transparent md:w-24 lg:w-28 2xl:w-32 dark:from-[#1a1a1a]"></div>
            <Carousel
              setApi={setApi}
            ...
            >
              <CarouselContent>
                {logos.map((logo, index) => (
                  <CarouselItem
                    className="basis-1/4 md:basis-1/5 lg:basis-1/6 lg:px-4 xl:px-6 2xl:basis-[15%]"
                    key={index}
                  >
                    <div className="group relative flex aspect-square items-center justify-center rounded-lg bg-[#EBEBEB] p-4 sm:p-6 dark:bg-[#2C2C2C]">
                      ...
                      />
                      {/* Entire label overlay is clickable */}
                      {logo.url ? (
                        <a
                          href={logo.url}
                          target="_blank"
